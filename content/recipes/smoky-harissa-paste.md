...
faq:
- "q: How to prep dried New Mexico chiles? a: Snap stems off first. Shake seeds out gently—don’t bruise skins. Rinse dirt quick—no soak—need some chew left or paste dulls. Listen for brittle crack when snapping. Dryness varies, so adjust carefully."
- "q: Can I use chipotle or ancho chiles instead? a: Yes, but flavor shifts. Chipotle more smoky, ancho sweeter. Heat levels change so lower quantities might be needed. Mixing them can balance better texture or heat. Experiment based on what’s handy."
- "q: Paste too thick or clumpy; fix? a: Add olive oil spoon by spoon while pulsing. Rest after each addition. Too thick paste won’t spread, tough to use. Avoid water or vinegar to thin—oil is key. If super thick, small blender batch better than big load."
